...
const Modificacion_Colaboracion = ({ llave , datos}) => {
  ...
  return (
    <>
    <div className="componente-col">
      <div className="datos-nmod-col">
      ...
      <div className="datos-lista-col">

      <div>Modificacion_colaboracion{llave}</div>
...
export default Modificacion_Colaboracion